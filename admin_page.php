...
function removeRow(rnum) {
	...
	if(rowNum > 0) {
		...
		alert("Rownum: "+ rowNum + ", rownum+1: " + (rowNum+1) );
...
function addScaledRows()
{
	...
	*
	* Might put this in the focusout method above...
	* When the user goes into the text box, pop the item at the corresponding index, then goes out,
	* add the movement into the corresponding index...
	*/
